...
exports.handler = async function (event, context) {
    try {
        ...
        const { fullNames, messages, nombres, emails, tele, dates, titles } = requestBody;

        console.log('Email details:', { fullNames, messages,nombres, dates, emails, tele, titles });
...
Le Tour : ${titles}  <br>
Le Nom : ${fullNames} <br>Email : ${emails} <br> Telephone : ${tele}  <br> Nombre des voyageurs : ${nombres}  <br> 
la Date : ${dates}  <br>
Message : ${messages} <br>
</p>
